...
public class CustomDialog extends Dialog implements View.OnClickListener {
    ...
    public interface OnSweetClickListener {
        void onClick(CustomDialog sweetAlertDialog);
    }
    ...
    private void SetButtonsMargins() {
        try
        {
            LinearLayout.LayoutParams lp = (LinearLayout.LayoutParams) mConfirmButton.getLayoutParams();
            lp.setMargins(10,0,10,0);
            mConfirmButton.setLayoutParams(lp);

            LinearLayout.LayoutParams lp2 = (LinearLayout.LayoutParams) mCancelButton.getLayoutParams();
            lp2.setMargins(10,0,10,0);

            mCancelButton.setLayoutParams(lp2);
        }
        catch (Exception e)
        {
    ...
    public CustomDialog setCustomImage (Drawable drawable) {
    ...
    public CustomDialog setCancelClickListener (OnSweetClickListener listener) {
        mCancelClickListener = listener;
        return this;
    }

    public CustomDialog setConfirmClickListener (OnSweetClickListener listener) {
